...
<?$APPLICATION->IncludeComponent("bitrix:catalog.section", "popular_section", Array(
	"ACTION_VARIABLE" => "action",	// Название переменной, в которой передается действие
		...
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"AND\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBProp:1:3\",\"DATA\":{\"logic\":\"Equal\",\"value\":1}}]}",	// Фильтр товаров
...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"SECTION_ELEMENT_ID" => $GLOBALS["CATALOG_CURRENT_ELEMENT_CODE"],
		"SECTION_ID" => $GLOBALS["CATALOG_CURRENT_SECTION_CODE"],
		"SHOW_CLOSE_POPUP" => "N",
