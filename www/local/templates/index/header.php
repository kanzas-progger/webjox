...
<body>
        ...
        <div class="container">
            <div class="header__wrp">
                    ...
                    <div class="header__nav-box header__search">
                        ...
                        <a href="#">
                            ...
                            array(
                                ...
                                "COMPONENT_TEMPLATE" => "index",
                                "EDIT_TEMPLATE" => "standard.php",
                                "PATH" => "/includes/icon_personal.php"
                            ),
                            false
                        ); ?>
                        </a>
                ...
                <div class="header__second-screen">
                    <picture>
                        <source srcset="<?=SITE_TEMPLATE_PATH?>/assets/img/bycicle-mobile.png" media="(max-width: 1400px)">
                        <source srcset="<?=SITE_TEMPLATE_PATH?>/assets/img/bicycle-first-screen.jpg">
                        <img src="<?=SITE_TEMPLATE_PATH?>/assets/img/bicycle-first-screen.jpg" alt="bicycle"/>
                    </picture>
                </div>
            </div>
        </div>
    ...
    <!-- тип инфоблоков - раздел, который содержит другие инфоблоки,
 например, Тип КОНТЕНТ, в нем есть блок главная страница -->

    <!-- популярные товары нужно выводить в зависимости от галочки, которую нужно
 поставить в инфоблоках -->